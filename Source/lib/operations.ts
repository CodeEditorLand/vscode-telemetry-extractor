...
export function populateProperties(
	properties: any,
	target: Event | Fragment,
	...
	for (const propertyName in properties) {
		...
		if (propertyName === keywords.include) {
			...
			target.properties.push(
				new Inline(propertyName, currentProperty[keywords.inline]),
			);
...
export function makeExclusionsRelativeToSource(
	sourceDir: string,
	excludedDirs: string[],
) {
